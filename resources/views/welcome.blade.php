...
{{--<thead>--}}
{{--<tr role="row">--}}
{{--    <th class="dt-not-orderable sorting_disabled"  aria-label="" style="width: 12.5px;">--}}
{{--        <input type="checkbox" class="select_all">--}}
{{--    </th>--}}
{{--    <th class="actions text-right dt-not-orderable sorting_disabled"  aria-label="Actions" style="width: 124.082px;">Name</th>--}}
{{--    <th class="actions text-right dt-not-orderable sorting_disabled"  aria-label="Actions" style="width: 124.082px;">Phone</th>--}}
{{--    <th class="actions text-right dt-not-orderable sorting_disabled"  aria-label="Actions" style="width: 124.082px;">Date</th>--}}
{{--    <th class="actions text-right dt-not-orderable sorting_disabled"  aria-label="Actions" style="width: 124.082px;">Time</th>--}}
{{--    <th class="actions text-right dt-not-orderable sorting_disabled"  aria-label="Actions" style="width: 124.082px;">Count</th>--}}
{{--    <th class="actions text-right dt-not-orderable sorting_disabled"  aria-label="Actions" style="width: 124.082px;">Message</th>--}}
{{--</tr>--}}
{{--</thead>--}}
{{--<tbody>--}}
...
{{--            <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Delete</span>--}}
{{--        </a>--}}
{{--        <a href="http://127.0.0.1:8000/admin/chefs/1/edit" title="Edit" class="btn btn-sm btn-primary pull-right edit">--}}
{{--            <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Edit</span>--}}
{{--        </a>--}}
{{--        <a href="http://127.0.0.1:8000/admin/chefs/1" title="View" class="btn btn-sm btn-warning pull-right view">--}}
